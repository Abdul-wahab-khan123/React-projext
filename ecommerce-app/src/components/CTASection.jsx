            ...
            <div className="relative overflow-hidden rounded-4xl">
                ...
                <div className="relative z-10 text-center p-56">
                    ...
                    <div className="text-center">
                        <Link to="/shop" className="group relative inline-flex items-center justify-center w-fit px-15 py-6 overflow-hidden rounded-3xl bg-(--secondary-color) text-xl font-semibold text-(--primary-color)">
